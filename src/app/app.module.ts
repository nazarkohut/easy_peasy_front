...
} from './components/section/input-validation/login/login-email-validation/login-email-validation.component';
import {
  LoginUsernameValidationComponent
} from './components/section/input-validation/login/login-username-validation/login-username-validation.component';
import {
  PasswordValidationComponent
} from './components/section/input-validation/password-validation/password-validation.component';
import {
  ValidationErrorMessageComponent
} from './components/section/input-validation/error-messages/client-validation/validation-error-message/validation-error-message.component';
import {
  ServerValidationErrorMessageComponent
} from './components/section/input-validation/error-messages/server-validation-error-message/server-validation-error-message.component';
import {
  AuthTermsWarningComponent
} from './components/section/text-content/auth-terms-warning/auth-terms-warning.component';
import {
  EmailValidationComponent
} from './components/section/input-validation/email-validation/email-validation.component';
import {
  RegisterTextValidationComponent
} from './components/section/input-validation/register-text-validation/register-text-validation.component';
import {BrowserAnimationsModule} from '@angular/platform-browser/animations';
import {
  ConfirmPasswordValidationComponent
} from './components/section/input-validation/confirm-password-validation/confirm-password-validation.component';
...
} from './components/section/forms/register-success-form/register-success-form.component';
...
} from './components/section/forms/activate-account-form/activate-account-form.component';
...
} from './components/section/forms/reset-password-confirm-form/reset-password-confirm-form.component';
import {
